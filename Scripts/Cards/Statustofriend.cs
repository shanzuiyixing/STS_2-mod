...
ArgumentNullException.ThrowIfNull(cardPlay.Target, "cardPlay.Target");
    // 播放角色施法动画
		...
		{
            CardModel clonedstatus = CardFactory.GetDistinctForCombat(cardPlay.Target.Player, ModelDb.CardPool<StatusCardPool>().GetUnlockedCards(cardPlay.Target.Player.UnlockState, cardPlay.Target.Player.RunState.CardMultiplayerConstraint), 1, base.Owner.RunState.Rng.CombatCardGeneration).FirstOrDefault();
